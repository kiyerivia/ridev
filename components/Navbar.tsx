    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          <Link
            href="/admin"
            className="text-xs font-semibold text-slate-400 hover:text-cyan-300 px-3 py-2 rounded-lg border border-slate-700/60 hover:border-cyan-500/40 transition-colors flex items-center gap-1.5"
            title="Admin Leads Inbox"
          >
          ...
          <div className="flex flex-col space-y-3">
            ...
            <div className="pt-4 border-t border-slate-800 flex flex-col gap-3">
              ...
              <Link
                href="/admin"
                onClick={() => setMobileMenuOpen(false)}
                className="text-center text-xs text-slate-400 hover:text-cyan-300 py-2"
              >
                🔐 Buka Admin Inbox
              </Link>
            </div>
